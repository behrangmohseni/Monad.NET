...
public static class ResultExtensions
{
    ...
    public static IActionResult ToActionResult<T, TError>(
        ...
        Func<TError, IActionResult> onErr)
    {
    ...
    /// </summary>
    public static IActionResult ToActionResultOrNotFound<T, TError>(this Result<T, TError> result)
    {
        return result.Match<IActionResult>(
            okFunc: value => new OkObjectResult(value),
    ...
    /// </summary>
    public static IActionResult ToActionResultWithProblemDetails<T, TError>(
        this Result<T, TError> result,
        string? title = null,
        int errorStatusCode = StatusCodes.Status400BadRequest)
    {
