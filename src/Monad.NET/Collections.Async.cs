...
public static partial class MonadCollectionExtensions
{
    ...
    /// <summary>
    /// Async version of Traverse for Options with cancellation-aware selector.
    /// </summary>
    public static async Task<Option<IReadOnlyList<U>>> TraverseAsync<T, U>(
        this IEnumerable<T> source,
        Func<T, CancellationToken, Task<Option<U>>> selector,
        CancellationToken cancellationToken = default)
    {
        ThrowHelper.ThrowIfNull(source);
        ThrowHelper.ThrowIfNull(selector);
    ...
    /// <summary>
    /// Async version of Traverse for Results with cancellation-aware selector.
    /// </summary>
    public static async Task<Result<IReadOnlyList<U>, TErr>> TraverseAsync<T, U, TErr>(
        this IEnumerable<T> source,
        Func<T, CancellationToken, Task<Result<U, TErr>>> selector,
        CancellationToken cancellationToken = default)
    {
        ThrowHelper.ThrowIfNull(source);
        ThrowHelper.ThrowIfNull(selector);
    ...
    /// <summary>
    /// Async version of Traverse for Validations with cancellation-aware selector.
    /// </summary>
    public static async Task<Validation<IReadOnlyList<U>, TErr>> TraverseAsync<T, U, TErr>(
        this IEnumerable<T> source,
        Func<T, CancellationToken, Task<Validation<U, TErr>>> selector,
        CancellationToken cancellationToken = default)
    {
        ThrowHelper.ThrowIfNull(source);
        ThrowHelper.ThrowIfNull(selector);
    ...
    /// <summary>
    /// Async version of Traverse for Tries with cancellation-aware selector.
    /// </summary>
    public static async Task<Try<IReadOnlyList<U>>> TraverseAsync<T, U>(
        this IEnumerable<T> source,
        Func<T, CancellationToken, Task<Try<U>>> selector,
        CancellationToken cancellationToken = default)
    {
        ThrowHelper.ThrowIfNull(source);
        ThrowHelper.ThrowIfNull(selector);
    ...
    /// <summary>
    /// Async version of Traverse for RemoteData with cancellation-aware selector.
    /// </summary>
    public static async Task<RemoteData<IReadOnlyList<U>, TErr>> TraverseAsync<T, U, TErr>(
        this IEnumerable<T> source,
        Func<T, CancellationToken, Task<RemoteData<U, TErr>>> selector,
        CancellationToken cancellationToken = default)
    {
        ThrowHelper.ThrowIfNull(source);
        ThrowHelper.ThrowIfNull(selector);
